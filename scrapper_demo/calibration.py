...
REPRODUCIBILITY_FILES = (
    ...
    (PROJECT_ROOT / "schemas" / "research_model_output.schema.json", "reproducibility/schemas/research_model_output.schema.json"),
    ...
    (PROJECT_ROOT / "schemas" / "market_search_results.schema.json", "reproducibility/schemas/market_search_results.schema.json"),
    ...
    (PROJECT_ROOT / "prompts" / "research_v2_system.md", "reproducibility/prompts/research_v2_system.md"),
